...
`C-TPT`[[ICLR'2024]]**C-TPT: CALIBRATED TEST-TIME PROMPT TUNING FOR
VISION-LANGUAGE MODELS VIA TEXT FEATURE DISPERSION**[[paper](https://openreview.net/pdf?id=jzzEHTBFOT)][[code](https://github.com/hee-suk-yoon/C-TPT)]  
